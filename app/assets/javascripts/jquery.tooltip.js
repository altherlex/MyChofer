...
(function($) {
   ...
   $.fn.tooltip = function(settings) {
     ...
     function _show(target_elm) {
			 /* Ao mostrar um balao fehcar todos os outros abertos */
     ...
     function _create(content_elm) {
			 var btn_fecha = "<a href='#' onclick=\"$(function(){$('.jquery-gdakram-tooltip').remove();})\" class='btn btn-close-jquery-tooltip'><i class='icon-remove'></i></a>";
       ...
       return $("<div class='jquery-gdakram-tooltip'>\
         ...
         <div class='content'>" + btn_fecha+header + $(content_elm).html() + "</div>\
